...
int main()
{
     ...
     for(i=0,c='A';i<n;i++,c++)
     {
         ...
         scanf("%d%d",&Q1[i].AT,&Q1[i].BT);                                                    //complexity=O(n)
...
for(i=0;i<n;i++)
{
  ...
  if(Q1[i].RT<=tq1)
  {
       ...
       printf("\n%c\t\t%d\t\t%d\t\t%d",Q1[i].name,Q1[i].BT,Q1[i].WT,Q1[i].TAT);                         //complexity=O(n)
    ...
    if(Q2[i].RT<=tq2)
     {
       ...
       Q2[i].RT=0;
       Q2[i].WT=time-tq1-Q2[i].BT;/*amount of time process has been waiting in the ready queue*/             //complexity=O(n)
...
for(i=0;i<r;i++)
    {
        Q3[i].TAT=Q3[i].CT;                                          //complexity=O(n)
